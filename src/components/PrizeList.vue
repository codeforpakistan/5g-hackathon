    ...
    <v-container class="py-md-8 py-lg-16 text-center">
      ...
      <v-row class="mt-8">
        <v-col cols="6" md="5" offset-md="1">
          ...
          <p class="text-h2 font-weight-bold">PKR 300,000</p>
        </v-col>
        <v-col cols="6" md="5">
          <h3 class="text-overline font-weight-bold text-primary">Second Place</h3>
          <p class="text-h2 font-weight-bold">PKR 200,000</p>
        </v-col>
